    ...
    <div class="modal">
      ...
      <div class="about-copy">
        <div class="about-block">
          <h4>Обо мне</h4>
          <p>Меня зовут Абдурахман!</p>
          <p>Независимый разработчик. Бот создан для упрощения учета ремонтов, адаптирован под разные типы сервисов.</p>
        </div>
        <div class="about-block">
          <h4>Разработка</h4>
          <p>Бот создан с помощь ИИ на базе ChatGPT под названием Codex</p>
        </div>
      </div>
      <div class="modal-actions">
